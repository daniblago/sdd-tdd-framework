...
const PHASES = [
  ...
  { id: 4, title: 'Arquitectura C4', icon: Layers, file: 'docs/04-arquitectura-y-blueprint.md', que: 'Topografía del ecosistema.', como: 'Diagrama con código Mermaid los contenedores (DB, UI) y decisiones ADR.', paraQue: 'Tener soporte conceptual gráfico de cómo fluye la estructura del servicio.' },
  { id: 5, title: 'Datos / Estado', icon: Database, file: 'docs/05-modelo-datos.md', que: 'Vectores de datos transaccionales.', como: 'Define entidades persistentes, columnas, y cargas de APIs JSON.', paraQue: 'Indicarle al frontend e Infraestructura exactamente la firma que recibirán.' },
  { id: 6, title: 'Roles y Acceso', icon: ShieldCheck, file: 'docs/06-roles-y-acceso.md', que: 'Matriz de control de acceso perimetral.', como: 'Cruza Roles (Guest, Admin) contra los Recursos productivos (Crear_Entidad).', paraQue: 'Desacoplar la protección sin codificar lógica espagueti.' },
  { id: 7, title: 'Flujos (Workflows)', icon: GitCommit, file: 'docs/07-flujos.md', que: 'Fábricas de cambio temporal.', como: 'Usa Mermaid stateDiagram para pintar mutaciones complejas del negocio.', paraQue: 'Resolución explícita del ciclo de vida de un documento o transacción.' },
  { id: 8, title: 'Blueprint TS', icon: CheckSquare, file: 'docs/08-plan-tecnico.md', que: 'Ingeniería fina del Typescript.', como: 'Escribe interfaces exactas sugeridas, utilitarios puros y las librerías obligatorias.', paraQue: 'Forzar al agente a usar el ecosistema exacto pactado en la constitución.' },
  { id: 9, title: 'Backlog TDD', icon: ListTodo, file: 'docs/09-backlog-tdd.md', que: 'Requerimientos unitarios troquelados.', como: 'Descompila la fase 3 etiquetando casos en base a [RED] y [GREEN].', paraQue: 'Es el comedero puro del Agente dev codificador del IDE. Esto es lo que lee para ejecutar.' },
  { id: 10, title: 'Agente Dev', icon: Code, file: 'docs/10-implementacion.md', que: 'Momento de verdad.', como: 'Fase simbólica: cierra el orquestador y delega al terminal la orden de construir software.', paraQue: 'Compilar la matriz documental en software tangible sin deuda técnica.' },
];
